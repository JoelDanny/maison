...
<html>
    ...
    <title>reservation achat de terrains</title>
    </head>
</html>
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav"> 
                        ...
                        <li><a href="accueil.php">Accueil</a></li>
                          ...
                          <li><a href="listelocatairemaison.php">Locataire maison</a></li>
    ...
    <div class="container" style="margin-top:2cm; background-color:white;"> 
        ...
        <table class="table table-striped table-bordered" border="3">
            ...
            <tbody>
                ...
                $db= Database::connect();
                $statment = $db->query('SELECT * FROM acheteurterrains');
                while($acheteurterrains = $statment->fetch()){

                   echo' <tr>';
                   echo' <td>'.$acheteurterrains['nom_achterrain'].'</td>';
                   echo' <td>'.$acheteurterrains['prenom_achterrain'].'</td>';
                   echo' <td>'.$acheteurterrains['email_achterrain'].'</td>';
                   echo' <td>'.$acheteurterrains['terrains_achterrain'].'</td>';
                   echo' <td>'.$acheteurterrains['phone_achterrain'].'</td>';
                   echo' <td>'.$acheteurterrains['today'].'</td>';
