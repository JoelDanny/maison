...
if (!empty($_POST)) {
    ...
    $db = Database::connect();
    $statment = $db->prepare('INSERT INTO listelocation (nom_location, prenom_location, email_location , phone_location , maison_locatio , today) VALUES (?,?,?,?,?,?)');
...
<?php
                    ...
                    $db = Database::connect();
                    $statment = $db->prepare('SELECT * FROM maisonenlocation WHERE id=?');
                    $statment->execute(array($id));
                    $maisonenlocation = $statment->fetch();
            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3" id="exterieur">
                    ...
                    <div class="col-sm-12" id="interieur">
                        ...
                        <form id="contact-form" method="POST" action="location.php"  role="form">
                            <div class="row">
                                ...
                                <div class="col-sm-12" style="margin-bottom: 0.5cm;">
                                        ...
                                        <input id="quartier"  name="quartier" class="form-control" disabled="disabled"  value="<?php echo''.$maisonenlocation['quartier'] ;  ?>">
                                    
                                </div>
                                <div class="col-sm-12" style="margin-bottom: 0.5cm;">
                                        <label for="ville">Ville<span class="blue"> *</span></label>
                                        <input id="ville"  name="ville" class="form-control" disabled="disabled"  value="<?php echo''.$maisonenlocation['ville'] ;  ?>">
                                    
                                 </div>
                                <div class="col-sm-12" style="margin-bottom: 0.5cm;">
                                        <label for="prix">Prix<span class="blue"> *</span></label>
                                        <input id="prix"  name="prix" class="form-control" disabled="disabled"  value="<?php echo''.$maisonenlocation['prix'] ;  ?>">
                                    
                                </div>
                                <div class="col-sm-12" style="margin-bottom: 0.5cm;">
                                    <label for="nombre">Nombre de Chambre<span class="blue"> *</span></label>
                                    <input id="nombre"  name="nombre" class="form-control" disabled="disabled"  value="<?php echo''.$maisonenlocation['chambres'] ;  ?>">
                                  </div>  

                                    <div class="col-sm-12" style="margin-bottom: 0.5cm;">
                                    <label for="cache"><span class="blue"></span></label>
                                    <input id="cache"  name="cache" class="form-control" type="hidden"  value="<?php echo''.$maisonenlocation['id'] ;  ?>">
                                    </div>
