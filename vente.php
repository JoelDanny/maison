...
<h4 class="titre"> MAISONS EN VENTE  </h4>

<div class="row" style="" >       
      <?php
      require "database.php";
      $db = Database::connect();
       $statment = $db->query('SELECT id,chambres,descriptio,ville,quartier,prix,images FROM maisonenlocation');
       $i=0;
       while($maisonenlocation = $statment->fetch()){
        ...
        switch ($i)  {
            ...
            echo '<div class="thumbnail">';
                 echo '<img src="images/'.$maisonenlocation['images'].'.jpg" alt="" >';
                 ...
                 echo '<a href="formventemaisons.php?id='.$maisonenlocation['id'].'" class="btn btn-success  bt2">Louez</a>';	
            ...
            echo '<div class="thumbnail">';
                 echo '<img src="images/'.$maisonenlocation['images'].'.jpg" alt="" >';
                  ...
                  echo'<div class="ville">'.$maisonenlocation['ville'].'</div>';
                  echo '<div class="description">'.$maisonenlocation['descriptio'].'</div>';
                 echo '<a href="formventemaisons.php?id='.$maisonenlocation['id'].'" class="btn btn-success bt2">Acheter</a>';
                 echo' <a href="voirmlocation.php?id='.$maisonenlocation['id'].'" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>';	
                 echo '</div>';
                 echo '</div>';
