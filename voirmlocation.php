                        ...
                        <div class="col-sm-6" style="padding-top:1cm;">
                            <form >
                                <div class="form-group">
                                    <label>Descripton: </label> <?php echo''.$maisonenlocation['descriptio'] ;  ?> <br><br>
                                    <label>Nombre de chambres: </label> <?php echo''.$maisonenlocation['chambres'] ;  ?><br>
                                    <label>Ville: </label> <?php echo''.$maisonenlocation['ville'] ;  ?><br>
                                    <label>Quartier: </label> <?php echo''.$maisonenlocation['quartier'] ;  ?><br>
                                    <label>Prix: </label> <?php echo''.$maisonenlocation['prix'] ;  ?> Fcfa
