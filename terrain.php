		    	...
		    	<ul class="nav navbar-nav">
                    <li><a href="index.php">Accueil</a></li>
                      ...
                      <ul class="dropdown-menu">
                          <li style="border-bottom: 1px solid white;"><a href="mlocation.php">en location</a></li>
...
<h4 class="titre"> TERRAINS EN VENTE  </h4>
        ...
        switch ($i)  {
            ...
            echo '<div class="thumbnail">';
                 echo '<img src="images/'.$terrains['images'].'.jpg" alt="" >';
                  echo '<div class="prixlocationt">'.$terrains['prix'].'/sem</div>';
                  echo'<div class="ville">'.$terrains['ville'].'</div>';
                  echo '<div class="description">'.$terrains['descriptio'].'</div>';
                 echo '<a href="formachatterrains.php?id='.$terrains['id'].'" class="btn btn-success ">Acheter</a>';	
                 echo' <a href="voirterrain.php?id='.$terrains['id'].'" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>';
                 echo '</div>';
                 echo '</div>';
            ...
            echo '<div class="thumbnail">';
               echo '<img src="images/'.$terrains['images'].'.jpg" alt="" >';
                ...
                echo'<div class="ville">'.$terrains['ville'].'</div>';
                echo '<div class="description">'.$terrains['descriptio'].'</div>';
               echo '<a href="formachatterrains.php?id='.$terrains['id'].'" class="btn btn-success ">Louer</a>';	
               echo' <a href="voirterrain.php?id='.$terrains['id'].'" class="btn btn-default"><span class="glyphicon glyphicon-eye-open"></span> Voir</a>';
               echo '</div>';
               echo '</div>';
